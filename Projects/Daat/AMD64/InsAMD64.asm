...
;     );
        ...
        LEAF_ENTRY __ins_sldt, _TEXT$00
        
        sldt word ptr [rcx]
        
        ret
        
        LEAF_END __ins_sldt, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_str, _TEXT$00
        
        str word ptr [rcx]
        
        ret
        
        LEAF_END __ins_str, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_segment_limit, _TEXT$00
        ...
        LEAF_END __ins_segment_limit, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_segment_ar, _TEXT$00
...
@@ :
        ...
        LEAF_END __ins_segment_ar, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_readmsr, _TEXT$00
        ...
        LEAF_END __ins_readmsr, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_writemsr, _TEXT$00
        ...
        LEAF_END __ins_writemsr, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_invept, _TEXT$00
        ...
        LEAF_END __ins_invept, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_invvpid, _TEXT$00
        
        db 066h, 00fh, 038h, 081h, 00ah ; invept ecx, xmmword ptr [rdx]
        ...
        LEAF_END __ins_invvpid, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_on, _TEXT$00
        ...
        LEAF_END __ins_vmx_on, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_off, _TEXT$00
        ...
        LEAF_END __ins_vmx_off, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_vmclear, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmclear, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_vmptrld, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmptrld, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_vmptrst, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmptrst, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_vmread, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmread, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __ins_vmx_vmwrite, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmwrite, _TEXT$00
...
;    );
        ...
        LEAF_ENTRY __ins_vmx_vmlaunch, _TEXT$00
        ...
        LEAF_END __ins_vmx_vmlaunch, _TEXT$00
...
;     );
        ...
        LEAF_ENTRY __vmx_trap, _TEXT$00
...
;     );
        ...
        NESTED_ENTRY __ins_cpuid, _TEXT$00
        ...
        NESTED_END __ins_cpuid, _TEXT$00
