...
@rem set LABS=%~dp0..\
@rem cd /d "%LABS%"
@rem git clone https://github.com/9176324/Daat
...
@if not exist "%SLND%Build\Objs\Daat" md "%SLND%Build\Objs\Daat"
...
:x86
@cd /d "%SLND%Projects\Daat"
@NMAKE /NOLOGO REBUILD PLATFORM=x86 PROJ=Daat
...
:x64
@cd /d "%SLND%Projects\Daat"
@NMAKE /NOLOGO REBUILD PLATFORM=x64 PROJ=Daat
